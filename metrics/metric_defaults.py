...
metric_defaults = EasyDict([(args.name, args) for args in [
    # ADA paper.
    EasyDict(name='fid50_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=50, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)),
    ...
    # Legacy: StyleGAN2.
    EasyDict(name='fid100',          class_name='metrics.frechet_inception_distance.FID', max_reals=100, num_fakes=100, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None)),
