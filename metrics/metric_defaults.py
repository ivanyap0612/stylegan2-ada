...
metric_defaults = EasyDict([(args.name, args) for args in [
    # ADA paper.
    EasyDict(name='fid3k_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=3000, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)),
    ...
    # Legacy: StyleGAN2.
    EasyDict(name='fid3k',          class_name='metrics.frechet_inception_distance.FID', max_reals=3000, num_fakes=3000, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None)),
